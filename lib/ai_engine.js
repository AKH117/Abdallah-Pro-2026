...
The student (${studentName}) sent a detailed breakdown of a medical question he answered incorrectly, formatted in 5 structured sections:
1. ترجمة رأس السؤال والمصطلحات الصعبة (Question translation & difficult medical jargon)
2. ليه الإجابة الصح صح (Physiological / radiological / clinical mechanism of correct answer)
3. ليه باقي الإجابات التانية غلط (Why each incorrect distractor is wrong)
4. تذكير بالمنهج والمنطقة المحيطة بالسؤال (High-yield curriculum summary & surrounding context)
5. نصائح ذهبية وتحشيشة للحفظ صم (Golden exam tips and Mnemonic scheme)

YOUR TASK:
Extract this data meticulously into structured JSON without losing any clinical value or nuanced explanations.
Determine the appropriate 4th-year medical course code:
- 'CAD402' (Cardiovascular / Cardiac Disorders)
- 'PED401' (Pediatrics)
- 'RSD403' (Respiratory Disorders)
- 'HVD404' (Hematology / Vascular)
- 'SKL 7' (Clinical Skills)

Output strictly valid JSON with this exact schema:
{
  "course_code": "CAD402",
  "topic": "Concise medical topic title in Arabic or English (e.g. Left Atrial Enlargement in CXR)",
  "question_en": "The exact English question stem as given",
  ...
  "correct_mechanism": "الشرح الفسيولوجي والأشعة لسبب صحة الإجابة بالتفصيل",
  "distractors": [
  ...
  "conversational_reply": "تشجيع طبي أخوي دافئ لدكتور عبدالله بالعامية المصرية مع تلخيص سريع للتحشيشة"
}`;
