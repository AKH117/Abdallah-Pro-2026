...
export function registerHandlers(bot) {
  ...
  const G7_WEEKLY_MAP = {
    'أحد': {
      isCollegeDay: true,
      m1: { time: '08:45 - 10:25 ص', name: '🫀 محاضرة قلب (CAD Intro to Cardiology)', loc: 'مدرج الكلية' },
      m2: { time: '10:30 - 12:10 م', name: '🫀 محاضرة رسم قلب (CAD Normal ECG)', loc: 'مدرج الكلية' },
      s1: { time: '12:30 - 02:10 م', name: '💬 SGD CAD (مناقشة حالات)', loc: 'المستشفى — قاعة 14' },
      s2: { time: '02:15 - 03:55 م', name: '🩺 SGT CAD (تدريس إكلينيكي)', loc: 'الأقسام والعيادات الخارجية' },
      studyTarget: 'مقدمة الكارديولوجي وفسيولوجيا ورسم القلب الطبيعي (Normal ECG)'
    },
    'إثنين': {
      isCollegeDay: false,
      m1: { time: '08:45 - 12:10 م', name: '☕ مراجعة ذاتية واستذكار حر لموديول القلب', loc: 'المكتبة / المنزل' },
      s1: { time: '12:30 - 02:10 م', name: '🧪 Open Lab معمل المهارات', loc: 'المستشفى — قاعة 1' },
      s2: { time: '02:15 - 03:55 م', name: '📚 جلسة مذاكرة عميقة وحل كويزات الكارديو', loc: 'المنزل' },
      studyTarget: 'رسم القلب وحساب المحاور والمسافات (Normal ECG Criteria)'
    },
    'ثلاثاء': {
      isCollegeDay: true,
      m1: { time: '08:45 - 10:25 ص', name: '🫀 محاضرة صمامات (CAD Mitral Valve Diseases)', loc: 'مدرج الكلية' },
      m2: { time: '10:30 - 12:10 م', name: '👶 محاضرة نمو أطفال (PED Growth & Assessment)', loc: 'مدرج الكلية' },
    ...
    'أربعاء': {
      isCollegeDay: true,
      m1: { time: '08:45 - 10:25 ص', name: '👶 محاضرة نمو أطفال (PED Growth Disorders)', loc: 'مدرج الكلية' },
      m2: { time: '10:30 - 12:10 م', name: '🫀 محاضرة صمامات أورطي (CAD Aortic Valve Diseases)', loc: 'مدرج الكلية' },
    ...
    'خميس': {
      isCollegeDay: true,
      m1: { time: '08:45 - 10:25 ص', name: '🫀 صمامات وثلاثي (CAD Tricuspid & Prosthetic)', loc: 'مدرج الكلية' },
      m2: { time: '10:30 - 12:10 م', name: '🫀 تصلب ودهون (CAD Atherosclerosis & Lipids)', loc: 'مدرج الكلية' },
  ...
  async function handleMyScheduleHub(ctx, edit = false) {
    ...
    if (todayData && todayData.isCollegeDay) {
      if (currentMins < 525) {
        ...
        nextUpStatus = `⏰ <b>غداً صباحاً:</b> يوم دراسي جديد مليء بالإنجاز 🌅`;
      }
    } else {
      if (todayKey === 'إثنين') {
        rightNowStatus = `🧪 <b>يوم المهارات والاستذكار الحر:</b> لا توجد محاضرات مدرج اليوم؛ فرصة ذهبية لإنهاء موديول القلب.\n• معمل المهارات المفتوح متاح في المستشفى (<b>قاعة 1</b>).`;
        nextUpStatus = `⏰ <b>الثلاثاء:</b> محاضرات الصمامات والأطفال من 08:45 ص`;
        ...
        nextUpStatus = `⏰ <b>السبت:</b> يوم التأسيس والمذاكرة العميقة 👑`;
      } else {
        rightNowStatus = `👑 <b>سبت التأسيس والمذاكرة العميقة:</b> إنهاء أي متأخرات وتثبيت شباتر الكارديو قبل بداية الأسبوع.`;
        nextUpStatus = `⏰ <b>الأحد 08:45 ص:</b> بداية أسبوع الكلية الجديد 🏛️`;
      }
    }
