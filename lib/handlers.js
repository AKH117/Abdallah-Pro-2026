...
export function registerHandlers(bot) {
  ...
  bot.use(async (ctx, next) => {
    ...
    // Ensure native persistent Web App Menu Button is set for this chat (only if chat exists)
  ...
  function buildDynamicMenuKeyboard(profile, fromId) {
    ...
    // Row 0: 📅 قسم الجدول بتاعي (جروب 7) + 🧭 أعمل إيه دلوقتي؟
    rows.push([
      { text: '📅 قسم الجدول بتاعي (جروب 7)', callback_data: 'btn_my_schedule' },
    ...
    if (prefs.schedule !== false) {
      row2.push({ text: '📅 جدول مواعيدي وسكاشني', callback_data: 'btn_my_schedule' });
    }
  ...
  async function handleMyScheduleHub(ctx, edit = false) {
    ...
    const todayData = todayKey ? G7_WEEKLY_MAP[todayKey] : null;
    ...
    if (todayData && todayData.isCollegeDay) {
      if (currentMins < 525) {
        ...
        rightNowStatus = `🩺 <b>أنت الآن في سكشن/راوند جروب 7 الأول:</b>\n• <b>${todayData.s1.name}</b>\n📍 <b>المكان:</b> <b>${todayData.s1.loc}</b>`;
        ...
        rightNowStatus = `🩺 <b>أنت الآن في سكشن/راوند جروب 7 الثاني:</b>\n• <b>${todayData.s2.name}</b>\n📍 <b>المكان:</b> <b>${todayData.s2.loc}</b>`;
    ...
    let msg = `📅 <b>قسم الجدول بتاعي • د. عبدالله (جروب 7) 🩺✨</b>\n`;
    msg += `━━━━━━━━━━━━━━━━━━━━━\n`;
    ...
    msg += `💡 <i>كل قاعة وسكشن مخصصين لجروب 7 مبرمجين بدقة لمنع أي تشتيت!</i>`;
    ...
    const keyboard = {
      inline_keyboard: [
        ...
        [
          { text: '📋 جدول الأسبوع الكامل لجروب 7', callback_data: 'btn_view_full_week_g7' },
  ...
  bot.action('btn_view_full_week_g7', async (ctx) => {
    await ctx.answerCbQuery().catch(() => {});
    let fullMsg = `📋 <b>جدول الأسبوع الرسمي لـ جروب 7 (Group 7 - Block 7) 🏛️</b>\n`;
    fullMsg += `━━━━━━━━━━━━━━━━━━━━━\n\n`;

    fullMsg += `🗓️ <b>الأحد:</b>\n`;
    fullMsg += `• 08:45 - 10:25 ص: 🫀 CAD Intro to Cardiology\n`;
    fullMsg += `• 10:30 - 12:10 م: 🫀 CAD Normal ECG\n`;
    fullMsg += `• 12:30 - 02:10 م: 💬 <b>SGD CAD</b> (المستشفى — <b>قاعة 14</b>)\n`;
    fullMsg += `• 02:15 - 03:55 م: 🩺 <b>SGT CAD</b> (الأقسام والعيادات)\n\n`;

    fullMsg += `🗓️ <b>الإثنين:</b>\n`;
    ...
    fullMsg += `🗓️ <b>الثلاثاء:</b>\n`;
    fullMsg += `• 08:45 - 10:25 ص: 🫀 CAD Mitral Valve Diseases\n`;
    fullMsg += `• 10:30 - 12:10 م: 👶 PED Growth & Assessment\n`;
    fullMsg += `• 12:30 - 02:10 م: 🏥 <b>Alex CAD</b> (المستشفى — <b>قاعة 15</b>)\n`;
    fullMsg += `• 02:15 - 03:55 م: 🩺 <b>Clinical CAD</b> (المستشفى — <b>قاعة 10</b>)\n\n`;

    fullMsg += `🗓️ <b>الأربعاء:</b>\n`;
    fullMsg += `• 08:45 - 10:25 ص: 👶 PED Disorders of Physical Growth\n`;
    fullMsg += `• 10:30 - 12:10 م: 🫀 CAD Aortic Valve Diseases\n`;
    fullMsg += `• 12:30 - 02:10 م: 🔬 <b>Skill Lab 7</b> (المستشفى — <b>قاعة 4</b>)\n`;
    fullMsg += `• 02:15 - 03:55 م: 📋 <b>Cases 7&8</b> (مبنى 3 — <b>قاعة 3103</b>)\n\n`;

    fullMsg += `🗓️ <b>الخميس:</b>\n`;
    fullMsg += `• 08:45 - 10:25 ص: 🫀 CAD Tricuspid & Prosthetic Valves\n`;
    fullMsg += `• 10:30 - 12:10 م: 🫀 CAD Atherosclerosis & Dyslipidemia\n`;
    fullMsg += `• 12:30 - 02:10 م: 👶 <b>SGT & SGD PED</b> (مبنى 2 — <b>قاعة 2018</b>)\n`;
    fullMsg += `• 02:15 - 03:55 م: 👶 <b>Clinical PED</b> (المستشفى — <b>قاعة 12</b>)\n\n`;
