...
async function runUserCycle(bot, user) {
  ...
  if (prefs.academic !== false) {
    try {
      ...
      // 🛡️ فلترة صارمة: التأكد التام من أن السؤال خاص بموديولات الطب البشري فقط واستبعاد أي أسئلة أخرى نهائياً
  ...
  // ============================================================================
  // 2.5 🩺 شرح دروس المنهج الطبي المعتمد (Medical Curriculum Lessons Block 7)
  //     إرسال شروح تفصيلية بالمصري والإكلينيكي للقلب والأطفال بأعلى أولوية
  // ============================================================================
  if (prefs.academic !== false && Number(chatId) === ADMIN_CHAT_ID) {
    try {
