      ...
      if (currentTimeMinutes >= 990 && currentTimeMinutes <= 1020) {
        ...
        if (await claimNotification(afternoonKey, 86400000)) {
          ...
          if (dayName.includes('سبت')) {
            ...
            quizCallback = `take_sharia_quiz_${sharia.id}`;
            ...
            quizCallback = 'take_statesman_quiz';
            ...
            quizCallback = `take_sahabi_quiz_${sahabi.item?.id || ''}`;
            ...
            quizCallback = `take_bukhari_quiz_${bukhari.item?.id || ''}`;
            ...
            quizCallback = `take_discipline_quiz_${disc.item?.id || ''}`;
          ...
          if (pearlMsg) {
            ...
            const keyboard = {
              inline_keyboard: [
                [{ text: '🎯 اختبرني الآن فوراً', callback_data: quizCallback }],
                [{ text: '✅ تم الاستيعاب والتدبر (+20 XP)', callback_data: 'ack_read_calm' }]
              ]
            };
